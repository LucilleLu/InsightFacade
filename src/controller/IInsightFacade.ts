...
export type IArr = Array<ICourse|IRoom>;
...
export interface ICourse {
    ...
    courses_lowestgrade: number;
    courses_withdrew: number;
    courses_highestgrade: number;
    courses_session: string;
    courses_campus: string;
}
